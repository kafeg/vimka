...
Package {
    ...
    Item {
        ...
        Item {
            ...
            Image {
                id: originalImage; smooth: true; source: preview
            ...
            Button {
                id: sendButton; label: qsTr("Send"); rotation: 3
                anchors.horizontalCenter: parent.horizontalCenter
                onClicked: {
                    photosModel.photoSelected(preview, hq, title, aid, owner_id, fromId);
                }
            }
